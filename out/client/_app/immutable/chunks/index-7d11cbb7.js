...
function Q(t) {
	...
	for (let l = 0; l < n.length; l++) {
		const u = n[l].claim_order,
			f = (r > 0 && n[e[r]].claim_order <= u ? r + 1 : K(1, r, (y) => n[e[y]].claim_order, u)) - 1;
		i[l] = e[f] + 1;
		const a = f + 1;
...
function it(t, n, e, i) {
	const { fragment: r, on_mount: s, on_destroy: c, after_update: o } = t.$$;
	r && r.m(n, e),
		i ||
			N(() => {
				const l = s.map(B).filter(G);
...
function Ct(t, n, e, i, r, s, c, o = [-1]) {
	...
	if (
		((u.ctx = e
			? e(t, n.props || {}, (a, y, ...j) => {
					...
					return (
						u.ctx &&
							r(u.ctx[a], (u.ctx[a] = C)) &&
							(!u.skip_bound && u.bound[a] && u.bound[a](C), f && ct(t, a)),
						y
					);
			  })
			: []),
		...
		n.intro && et(t.$$.fragment), it(t, n.target, n.anchor, n.customElement), J(), F();
	}
	h(l);
}
class kt {
